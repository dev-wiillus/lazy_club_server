...
registerEnumType(ChannelBillingPolicyStatus, {
	name: 'ChannelBillingPolicyStatusType',
});
...
export class ChannelBillingPolicyEntity {
	...
	@Field((type) => ChannelBillingPolicyStatus, {
		defaultValue: ChannelBillingPolicyStatus.FREE,
	})
	@Column({
		comment: '채널 과금 정책 상태',
		type: 'enum',
